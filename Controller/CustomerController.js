...
$('#CustomerManage .saveBtn').click(function(){
    ...
    cusMobile = $('#CustomerManage .cusMobile').val();
...
function validate(customer){
    ...
    if(customer.cusMobile != null && customer.cusMobile > 0){
        $('#CustomerManage .invalidCusMobile').text('');
        if(valid){
            valid = true;
        }
    }
        ...
        $('#CustomerManage .invalidCusMobile').text('Invalid Customer Mobile Number');
        valid = false;
    }
...
$('#CustomerManage .searchBtn').click(function(){
    ...
    if(customer){
        ...
        $('#CustomerManage .cusMobile').val(customer.cusMobile);
    }
    else{
...
$('#CustomerManage .tableRow').on('click', 'tr', function(){
    ...
    $('#CustomerManage .custSalary').val(mobile);
});
